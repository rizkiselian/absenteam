...
<div class="panel-header bg-primary-gradient">
    <div class="page-inner py-4">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
            <h3 class="text-white pb-3 fw-bold">DATA KEHADIRAN TENAGA KONTRAK PER UNIT KERJA</h3>
        </div>
    </div>
</div>
...
<div class="page-inner mt--5">
    <div class="card full-height">
        <div class="card-body">
            ...
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="mt-3 mb-1 text-success">DAFTAR TENAGA KONTRAK HADIR</h3>
                    <hr class="mt-0 mb-1">
                    ...
                    <h3 class="mt-5 mb-1 text-danger">DAFTAR TENAGA KONTRAK ABSEN (IZIN/SAKIT/TANPA KETERANGAN)</h3>
                    <hr class="mt-0 mb-1">
    ...
    <script>
        ...
        function load_data(skpd, tgl_kehadiran) {
            ...
            table = $('#tabel-hadir').DataTable({
                ...
                ajax: {
                    url: '<?= site_url('load-tenaga-kontrak-hadir/'); ?>' + skpd + '/' + tgl_kehadiran,
                    type: 'POST'
                },
                columns: [{
                    data: 'no'
            ...
            table = $('#tabel-tidak-hadir').DataTable({
                ...
                ajax: {
                    url: '<?= site_url('load-tenaga-kontrak-tidak-hadir/'); ?>' + skpd + '/' + tgl_kehadiran,
                    type: 'POST'
                },
                columns: [{
                    data: 'no'
