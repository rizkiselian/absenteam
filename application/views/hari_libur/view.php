...
<div class="panel-header bg-primary-gradient">
    <div class="page-inner py-4">
        <div class="d-flex align-items-left flex-column flex-sm-row">
            <h3 class="text-white pb-3 fw-bold">DATA HARI LIBUR</h3>
            <?php if ($role == "admin") : ?>
...
<script>
    ...
    $(document).on("click", "#tombol-tambah", function() {
        ...
        $.ajax({
            url: '<?= site_url('form-add-hari-libur'); ?>',
            type: "POST",
    ...
    $(document).on("click", "#tombol-ubah", function() {
        $.ajax({
            url: '<?= site_url('form-edit-hari-libur'); ?>',
            type: "POST",
            data: {
                hari_libur: $(this).data('id')
            },
            success: function(data) {
    ...
    $(document).on("click", "#tombol-hapus", function(e) {
        ...
        swal({
            ...
            if (Delete) {
                $.ajax({
                    url: '<?= site_url('delete-hari-libur'); ?>',
                    type: "POST",
                    data: {
                        hari_libur: $(this).data('id')
                    },
